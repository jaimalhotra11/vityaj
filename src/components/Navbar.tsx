          ...
          <div className="hidden md:flex items-center space-x-6">
            {navItems.map((item) => (
              ...
              >
                ...
                <div className="absolute left-0 mt-0 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 bg-white dark:bg-gray-800 rounded-lg shadow-xl py-2">
            ...
            {isAuthenticated ? (
              <>
                {userRole === 'admin' ? (
                  <Link
                    to="/admin"
                    className="block w-full bg-gray-100 text-gray-700 text-center px-6 py-2 rounded-lg hover:bg-gray-200 transition-colors"
                  >
                    Admin Panel
                  </Link>
                ) : (
