...
function Parul() {
  ...
  const overviewDetails = {
    highlights: [
      "Established in August 2016 by the 178-year-old Parul, Coleman and Co. Ltd group",
        ...
        <div className="grid grid-cols-3 gap-8 flex-grow">
                  ...
                  <>
                    <div className="border-l-4 border-purple-600 pl-4 py-2">
                      <p className="text-gray-700 text-lg">
                        Parul University has been established in August, 2016 in the beautiful city of Greater Noida, 
                        just 35 km away from the national capital Delhi, by the 178 years old Parul, Coleman and Co. Ltd group. 
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-8 bg-purple-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700">
                Parul University prides itself on academic excellence with more than 95% of faculty 
            ...
            <div className="mt-4 bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700">
                ...
                Parul University provides students with global exposure and industry-relevant education.
              </p>
            </div>
          </div>
        </div>
